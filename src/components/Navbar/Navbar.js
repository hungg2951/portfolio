...
function Navbar() {
  const { theme, setHandleDrawer, changeTheme  } = useContext(ThemeContext);
    ...
    <div className="navbar">
      ...
      >
        ...
        <div className="theme-switcher">
          <p style={{ color: theme.primary }}>🎨 THEME</p>
          <div className="theme-dots">
            {themeList.map((item) => (
              <div
                key={item.name}
                className={`theme-dot ${theme === item.theme ? "active" : ""}`}
                style={{ background: item.theme.primary }}
